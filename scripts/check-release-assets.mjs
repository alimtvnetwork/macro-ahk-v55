 ...
 *
 * Env:
 *   RELEASE_TAG       required, for example v5.25.0
 *   GITHUB_REPOSITORY required, owner/repo
 *   GITHUB_TOKEN      optional, raises the API rate limit
 *
 * Run: RELEASE_TAG=v5.25.0 node scripts/check-release-assets.mjs
 */
...
async function main() {
    ...
    if (!tag) {
        console.error("[FATAL] RELEASE_TAG is not set. Expected the published tag, for example v5.25.0.");
        process.exit(1);
    }
    if (!slug) {
