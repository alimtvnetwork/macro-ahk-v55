...
.EXAMPLE
  ...
  irm https://github.com/alimtvnetwork/macro-ahk-v55/releases/download/v2.158.0/install.ps1 | iex
...
if (-not $script:MarcoDefaultRepo)        { $script:MarcoDefaultRepo        = 'alimtvnetwork/macro-ahk-v55' }
