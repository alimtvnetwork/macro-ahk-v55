...
#
# Usage:
#   curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v55/releases/latest/download/install-prompt-creator.sh | bash
#   # or pinned:
#   PROMPT_CREATOR_VERSION=v4.8.0 ./install.sh
set -euo pipefail

REPO="${PROMPT_CREATOR_REPO:-alimtvnetwork/macro-ahk-v55}"
