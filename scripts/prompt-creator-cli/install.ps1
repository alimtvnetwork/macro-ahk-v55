...
.EXAMPLE
  iwr https://github.com/alimtvnetwork/macro-ahk-v55/releases/latest/download/install-prompt-creator.ps1 | iex
#>
[CmdletBinding()]
param(
  [string]$Repo    = $(if ($env:PROMPT_CREATOR_REPO)    { $env:PROMPT_CREATOR_REPO }    else { 'alimtvnetwork/macro-ahk-v55' }),
