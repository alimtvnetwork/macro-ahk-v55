...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v55/main/scripts/prompt-creator-cli/install.sh | bash
...
```powershell
iwr https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v55/main/scripts/prompt-creator-cli/install.ps1 | iex
