 ...
 *
 * @see src/background/handlers/handler-guards.ts ΓÇö input validation + safeBind
 * @see .lovable/memory/architecture/project-scoped-database.md ΓÇö Project-scoped DB
 */
