...
Define the platform-adapter and chrome-adapter interfaces — abstracting chrome.* APIs behind a typed surface so unit tests can mock cleanly. Include the typed chrome-api-types layer.

---

## Source material to distill (private — do NOT cite in final body)

mem://architecture/platform-adapter-pattern, `src/platform/`
