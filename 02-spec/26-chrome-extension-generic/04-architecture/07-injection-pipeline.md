# Seven-Stage Injection Pipeline
...
Document the seven stages: 1) dependency resolve, 2) namespace bootstrap, 3) require() loader, 4) controller mount, 5) auth gate, 6) UI ready, 7) marker set. One paragraph per stage + a sequence diagram.
