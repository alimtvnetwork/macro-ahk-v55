# Namespace Registration & Self-Test
...
Document the register{Name}SelfNamespace() factory pattern and the runtime self-test that logs PASS/FAIL on every page load — surfacing regressions immediately.

---

## Source material to distill (private — do NOT cite in final body)

`standalone-scripts/marco-sdk/src/{self-namespace,self-test}.ts`
