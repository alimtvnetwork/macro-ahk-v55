...
Define the canonical top-level folder tree for any project built from this blueprint. Show src/, standalone-scripts/, scripts/, spec/, public/, dist/, release/, tests/, with one-line purpose per folder.

---

## Source material to distill (private — do NOT cite in final body)

current project root layout, `scripts/` folder, `standalone-scripts/` folder
