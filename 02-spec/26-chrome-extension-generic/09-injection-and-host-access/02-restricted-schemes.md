...
List the schemes Chrome refuses to inject into: chrome://, chrome-extension://, edge://, view-source:, file:// (without flag), Web Store domains. Provide a runtime guard helper.
