...
Document the decision tree: when to use manifest matches[], when to request optional_host_permissions, when activeTab is sufficient. Cover Web-Store risk implications of each.
