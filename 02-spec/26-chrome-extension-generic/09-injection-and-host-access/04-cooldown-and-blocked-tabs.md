...
Document the diagnostics data shape for blocked tabs (tabId, origin, errorCode, reason, attemptCount, nextRetryAt) and the canonical UI indicator that surfaces it. Mirrors TokenSeederStatusIndicator.

---

## Source material to distill (private — do NOT cite in final body)

`src/components/options/TokenSeederStatusIndicator.tsx`, `src/components/options/TokenSeederDiagnosticsPanel.tsx`
