...
Provide the canonical chrome.scripting.executeScript MAIN-world seeder template with fixed cooldown on failure (NOT exponential backoff), error categorisation, and diagnostics emission.
