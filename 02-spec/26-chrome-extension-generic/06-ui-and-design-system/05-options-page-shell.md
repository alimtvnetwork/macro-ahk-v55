...
Define the canonical Options page layout: sidebar nav + content area with direction-aware view transitions, ThemeProvider locked to dark by default, error boundary, version footer.

---

## Source material to distill (private — do NOT cite in final body)

`src/options/`, mem://ui/view-transition-patterns
