...
Justify the dark-only default (extension surface area, glare, focus). Provide a recommended dark palette with hex+HSL values and contrast targets (WCAG AA minimum). Document the optional light-mode opt-in path.

---

## Source material to distill (private — do NOT cite in final body)

mem://preferences/dark-only-theme, `src/components/theme/ThemeProvider.tsx`
