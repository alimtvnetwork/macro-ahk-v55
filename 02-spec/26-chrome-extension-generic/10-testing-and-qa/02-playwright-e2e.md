...
Document MV3 e2e setup: persistent context boot with --load-extension, service-worker handle, navigating to chrome-extension://<id>/options.html, screenshot diff.
