  ...
  "properties": {
    ...
    "standaloneArtifacts": {
      ...
      "properties": {
        "baseDir": {
          "type": "string",
          "description": "Root directory containing standalone script projects (relative to script location)",
          "examples": ["standalone-scripts"]
        },
        "required": {
          "type": "array",
          "description": "List of projects and their required dist artifacts",
          "items": {
            "type": "object",
            ...
            "properties": {
              "folder": {
                "type": "string",
                "description": "Project folder name under baseDir",
                "examples": ["marco-sdk", "macro-controller", "xpath"]
              },
              "files": {
                "type": "array",
                "items": {"type": "string"},
                "description": "Required filenames in the project's dist/ directory",
                "examples": [["marco-sdk.js"], ["macro-looping.js"]]
              }
            }
          }
        }
...
### Chrome Extension with Standalone Artifacts

```json
{
  "projectName": "Marco Chrome Extension",
  "backendDir": ".",
  "frontendDir": "chrome-extension",
  "buildCommand": "npm run build:extension",
  "standaloneArtifacts": {
    "baseDir": "standalone-scripts",
    "required": [
      { "folder": "marco-sdk", "files": ["marco-sdk.js"] },
      { "folder": "macro-controller", "files": ["macro-looping.js"] },
      { "folder": "xpath", "files": ["xpath.js"] }
    ]
  }
}
```

The `standaloneArtifacts` guard runs before the build command. If any listed file is missing or under 100 bytes, the build fails with `exit 3` and a `[FAIL]` message indicating which artifact is missing.
