...
- [LogLevel Enum](../../../../03-coding-guidelines-stale/03-coding-guidelines-spec/02-typescript/10-log-level-enum.md) — Canonical `LogLevel` enum (Debug, Info, Warn, Error, Fatal) used in color mappings
