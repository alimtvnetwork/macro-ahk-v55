...
> Cross-cutting errors used by `pkg/typecast/`. See [Casting Elimination Patterns](../../../03-coding-guidelines-stale/03-coding-guidelines-spec/01-cross-language/03-casting-elimination-patterns.md) for usage.
...
- Cast errors must **never** be swallowed — see §7.2 and §10 in [03-casting-elimination-patterns.md](../../../03-coding-guidelines-stale/03-coding-guidelines-spec/01-cross-language/03-casting-elimination-patterns.md)
