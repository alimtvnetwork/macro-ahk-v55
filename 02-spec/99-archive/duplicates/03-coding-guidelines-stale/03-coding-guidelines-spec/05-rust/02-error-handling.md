...
| Reference | Location |
|-----------|----------|
| Error Code Registry | `../../../03-error-manage-spec/04-error-manage-spec/03-error-code-registry/01-registry.md` |
| Error Resolution Spec | `../../../03-error-manage-spec/04-error-manage-spec/00-overview.md` |
