...
```powershell
$env:MARCO_DL_VERSION='v5.14.0'; $env:MARCO_DL_FOLDER='marco'; irm https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v53/main/scripts/download-extension.ps1 | iex
```
...
After it finishes, load the resulting folder via `chrome://extensions → Load unpacked`. The `marco-extension-v5.14.0.zip` backup sits next to it.
...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/macro-ahk-v53/releases/download/v5.14.0/install.ps1 | iex
...
```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v53/releases/download/v5.14.0/install.sh | bash
...
|------|-------------|---------|
| `-Version` | Pin a specific release (`vX.Y.Z[-pre]`) or `latest` | `-Version v5.14.0` |
