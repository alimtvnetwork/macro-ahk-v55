/**
 * Owner Switch popup — top-level mount.
 *
 * P7 deliverable: assembles the three sections, injects CSS, wires the
 * file input → render pipeline. No SQLite, no API, no run flow — those
 * land in P8–P10.
 */
