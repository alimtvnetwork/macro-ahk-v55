...
const CSS = [
  ...
  '  width:10px;height:10px;background:hsl(var(--background));',
  '}',
  ...
  '  background:hsl(var(--muted));color:hsl(var(--foreground));border:1px solid hsl(var(--muted));',
  ...
  '  background:hsl(var(--primary));color:hsl(var(--warning));',
  '}',
  ...
  '  #marco-prompt-modal select{',
  '    background:hsl(var(--background)) !important;color:hsl(var(--foreground)) !important;',
