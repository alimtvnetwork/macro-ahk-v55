import { JsonLogLevelType } from "../types/enums";

/**
 * MacroLoop Controller — JSON tab log line leaf.
 *
 * PlanTierType-17 step 16: extracted from `database-json-tab.ts` to break the
 * `database-json-tab ↔ database-json-migrate` runtime cycle (madge #10).
 *
 * Pure DOM helper, zero imports.
 */

export type JsonLogLevel = JsonLogLevelType;
