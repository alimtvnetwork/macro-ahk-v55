...
function renderWaterfallEntries(
  ...
  totalRow.style.cssText = CssFragmentType.FontSize9pxColor + cPanelFgDim + ';text-align:right;margin-top:2px;border-top:1px solid rgba(255,255,255,0.08);padding-top:2px;';
...
function buildWaterfallRow(
  ...
  dur.style.cssText = CssFragmentType.FontSize9pxColor + color + ';min-width:36px;text-align:right;white-space:nowrap;';
