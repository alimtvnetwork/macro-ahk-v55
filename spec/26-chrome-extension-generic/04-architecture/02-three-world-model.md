...
Explain the three execution contexts (background SW, content script ISOLATED, page MAIN), what APIs are available in each, why MAIN-world is required for page-namespace SDKs, and the rules for crossing boundaries.
