...
Define the canonical namespace shape: window.<RootNamespace> = { Projects: {<ProjectName>: {...}}, Logger }. Cover Object.freeze policy, per-project isolation, and how downstream scripts consume via require().

---

## Source material to distill (private — do NOT cite in final body)

mem://architecture/dynamic-script-loading, `standalone-scripts/marco-sdk/src/index.ts`, `standalone-scripts/types/riseup-namespace.d.ts`
