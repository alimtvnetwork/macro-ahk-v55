...
Define the regex that filters chunk-*.js and assets/*.js frames from stack traces — they have no diagnostic value. Apply at log-write time, not display time.

---

## Source material to distill (private — do NOT cite in final body)

mem://preferences/stack-trace-filtering
