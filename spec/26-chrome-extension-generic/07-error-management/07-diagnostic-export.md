...
Define the diagnostic ZIP bundle contract: logs.txt (human-readable), sessions.json, manifest snapshot, version, environment. This is the user-facing 'send us a bug report' artefact.

---

## Source material to distill (private — do NOT cite in final body)

mem://features/log-diagnostics-export, `src/lib/developer-guide-bundle.ts`
