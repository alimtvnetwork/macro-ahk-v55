...
Specify PascalCase for types/classes/SQLite tables/JSON keys, camelCase for variables/functions, SCREAMING_SNAKE_CASE for constants with required prefixes (ID_ for DOM ids, SEL_ for selectors, MSG_ for message types, KEY_ for storage keys).

---

## Source material to distill (private — do NOT cite in final body)

mem://architecture/constant-naming-convention, mem://standards/pascalcase-json-keys
