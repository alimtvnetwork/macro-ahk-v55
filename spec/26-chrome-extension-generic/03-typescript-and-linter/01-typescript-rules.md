...
Document every `compilerOptions` flag the blueprint requires (strict, noImplicitAny, strictNullChecks, noUncheckedIndexedAccess, exactOptionalPropertyTypes, etc.) with one-line justifications. Define the no-unknown policy and acceptable use of generics.

---

## Source material to distill (private — do NOT cite in final body)

`tsconfig.json`, mem://standards/unknown-usage-policy
