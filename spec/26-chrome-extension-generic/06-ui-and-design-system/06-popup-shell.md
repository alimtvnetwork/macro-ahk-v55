...
Define the canonical Popup layout: 360×600 baseline, header with project status, action log, debug panel toggle, footer with version. Document the popup-data hook pattern.
