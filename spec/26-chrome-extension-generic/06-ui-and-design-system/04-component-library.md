...
Document the shadcn-style primitive set required by every extension (Button, Input, Select, Dialog, Drawer, Toast, Tabs, Badge, Tooltip, Collapsible). Show the cva variant pattern with one full example.

---

## Source material to distill (private — do NOT cite in final body)

`src/components/ui/`, `spec/07-design-system/09-button-system.md`
