...
Define type scale (xs/sm/base/lg/xl/2xl/3xl), font-weight scale, line-height pairs, spacing scale (4-px base), and layout grid recommendations. All values referenced as Tailwind tokens.

---

## Source material to distill (private — do NOT cite in final body)

`spec/07-design-system/03-typography.md`, `spec/07-design-system/04-spacing-layout.md`
