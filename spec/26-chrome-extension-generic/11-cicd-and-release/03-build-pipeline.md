...
Document the full build pipeline: standalone scripts first → SDK → extension → packaging. Cover parallel-safe steps and artefact paths.

---

## Source material to distill (private — do NOT cite in final body)

`pipeline/05-build-chain.md`
