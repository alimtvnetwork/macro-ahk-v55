...
Document the GitHub Actions quality-badges workflow: which badges are generated (build, tests, lint, version), where they live, and the no-CI-notifications rule.

---

## Source material to distill (private — do NOT cite in final body)

`.github/workflows/quality-badges.yml`, mem://constraints/no-ci-notifications
