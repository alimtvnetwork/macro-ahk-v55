...
Mandate: sequential fail-fast. No recursive retry. No exponential backoff. No self-calls within the injection pipeline. Document the few permitted exceptions (fixed-cooldown re-attempt at outer scheduler level only).
