...
Document the single-path getBearerToken() pattern: zero-network resolution waterfall, 2-step recovery, no legacy fallbacks. Generic enough to wrap any Authorization-header service.

---

## Source material to distill (private — do NOT cite in final body)

mem://auth/unified-auth-contract, mem://architecture/auth-bridge-service, mem://auth/token-retrieval-strategy
