...
- [Error Handling Spec](../../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/01-error-handling-reference.md) — Cross-language error strategy
