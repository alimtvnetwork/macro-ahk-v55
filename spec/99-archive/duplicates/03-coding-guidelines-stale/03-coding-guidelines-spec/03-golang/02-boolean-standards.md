...
See [Boolean Principles P6](../01-cross-language/02-boolean-principles.md#principle-6-never-mix-positive-and-negative-booleans-in-a-single-condition) for the cross-language rule.
