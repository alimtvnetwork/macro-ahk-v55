...
|-----------|-----------------|
| `spec/03-error-manage-spec/04-error-manage-spec/02-error-architecture/04-error-modal/04-color-themes.md` | `LogLevel.Error`, `LogLevel.Warn`, `LogLevel.Info`, `LogLevel.Debug` color mappings |
