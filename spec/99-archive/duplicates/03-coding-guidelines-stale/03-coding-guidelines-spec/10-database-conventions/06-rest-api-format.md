...
All responses MUST use the **Universal Response Envelope** defined in the [Response Envelope Specification](../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/05-response-envelope/04-response-envelope-reference.md).
...
All examples below conform to the [Universal Response Envelope](../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/05-response-envelope/04-response-envelope-reference.md).
...
All responses use the [Universal Response Envelope](../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/05-response-envelope/04-response-envelope-reference.md). Summary:
...
| Reference | Location |
|-----------|----------|
| **Response Envelope Spec** | [04-response-envelope-reference.md](../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/05-response-envelope/04-response-envelope-reference.md) |
| Envelope examples | [envelope-minimal.json](../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/05-response-envelope/envelope-minimal.json), [envelope-single.json](../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/05-response-envelope/envelope-single.json), [envelope-multiple.json](../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/05-response-envelope/envelope-multiple.json) |
