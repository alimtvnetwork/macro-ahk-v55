...
- [AppError Result Types](../../../04-error-manage-spec-stale/04-error-manage-spec/02-error-architecture/06-apperror-package/01-apperror-reference/03-result-types.md) — Go Result[T] pattern
