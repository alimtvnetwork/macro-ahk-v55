 ...
 * (PlanTierType 25 Step 14). Owns per-event validation summary + card styling.
 */
...
// eslint-disable-next-line max-lines-per-function -- composition wrapper; PlanTierType 25 Step 14
