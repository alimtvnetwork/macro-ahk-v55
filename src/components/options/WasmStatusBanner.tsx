...
function classifyFixScenario(
  ...
  if (bootMentionsPnpmDlxLess) {
    return "build_tooling_pnpm_dlx_less";
  }

  if (isCspProbeBlocked && !declaresWasmEval) {
    return "manifest_missing_directive";
  }

  if (hasMismatch) {
    return "stale_build_reload_needed";
  }

  if (isCspProbeBlocked) {
    return "csp_blocked_unknown_cause";
  }
  ...
  if (bootError !== null && bootError !== "") {
    return "boot_failed_non_csp";
  }
