...
import { LogKindType, SeverityFilterType, SourceFilterType } from "../../standalone-scripts/macro-controller/src/types/enums";
...
export type SeverityFilter = SeverityFilterType;
export type SourceFilter = SourceFilterType;
